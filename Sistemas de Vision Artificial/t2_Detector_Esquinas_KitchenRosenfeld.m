...
%DETECTOR KITCHEN AND RODENFELD: Método matemático para la detección de 
%esquinas en una figura, hace lo mismo que el detector de Beaudet pero
%dependiendo de la imagen, puede servir mejor un detector o el otro.
...
%FÓRMULAS DETECTOR DE ESQUINAS KITCHEN ROSENFELD: Son distintas a las de
%Beaudet.
